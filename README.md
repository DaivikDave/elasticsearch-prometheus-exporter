...
`./bin/elasticsearch-plugin install -b https://github.com/DaivikDave/elasticsearch-prometheus-exporter/releases/download/7.17.9.0/prometheus-exporter-7.17.9.0.zip`
